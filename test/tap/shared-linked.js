...
var fixture = new Tacks(
  Dir({
    ...
    npmrc: File(
      'cache=/Users/rebecca/code/npm/test/tap/shared-linked/cache\n' +
      'prefix=/Users/rebecca/code/npm/test/tap/shared-linked/global\n' +
...
test('shared-linked', function (t) {
  var config = ['--userconfig', path.join(testdir, 'npmrc')]
  common.npm(config.concat(['install', '--dry-run']), {cwd: bugdir}, function (err, code, stdout, stderr) {
    if (err) throw err
    t.is(code, 0)
